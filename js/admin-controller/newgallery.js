...
angular.module('szczesniakAdmin')
    .controller('NewGalleryCtrl', function ($scope, $http, $window, Upload) {
        ...
        $scope.deleteImg = function (id) {
            ...
            $http.delete('http://pszcz.projekty.surprise.design:3456/imgD/' + id)
                .then(function () {
        ...
        $scope.updateImg = function (id, data) {
            console.log(data);
            $http.put('http://pszcz.projekty.surprise.design:3456/imgU/' + id, data)
                .then(function () {
                    console.log('update');
        ...
        $scope.img = img;   
            ...
            console.log(img);
            Upload.upload({
                url: 'http://pszcz.projekty.surprise.design:3456/img',
                arrayKey: '',
                data: {
                    file: file,
                    img: img
